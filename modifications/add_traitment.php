...
if(!isset($thisCurrentUser)) {
    ...
    if(! empty($_POST['competence'])) {
        // add selected competence to profil page    
        $requestAddSelectedCompetence = "INSERT INTO competence_profil (competence_id, profil_id, state_evol) VALUES(:competence, :profil, :state_evol)";
        $sendRequestAddSelectedCompetence = $bdd->prepare($requestAddSelectedCompetence);
        $sendRequestAddSelectedCompetence->execute([
        ...
        // Add new competence to list of all competences
